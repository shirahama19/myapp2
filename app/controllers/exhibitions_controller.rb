class ExhibitionsController < ApplicationController
  ...
  private
    ...
    def exhibition_params
      params.require(:exhibition).permit(:name, :place_ward, :place_name, :place_address, :station, :first_date, :last_date, :closed_date, :opening_time, :detail_text, :category_string)
    end
end
